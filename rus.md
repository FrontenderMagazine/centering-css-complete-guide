...
центрирования элементов  такое огромное количество, под разные ситуации, что 
выбрать нужный трудно.

Давайте построим древовидную схему для принятия решения и будем надеяться что 
оно значительно всё упростит.

Мне нужно отцентрировать элемент...

## По горизонтали

### Является ли он строчным или строчно-* (как текст или гиперссылки)?

Строчные элементы внутри блочного родительского элемента можно центрировать, 
применив:
...
буквально или же просто её имитацией на основе средств CSS. За центровку в этом 
...
Если вы имеете дело с некоей имитацией таблицы, возможно стоит использовать 
...
в стилизации текста могут изменить высоту. Вариации в количестве текста могут 
